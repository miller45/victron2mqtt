...
python3 victron_cli.py --port /dev/ttyUSB0 profiles
python3 victron_cli.py --port /dev/ttyUSB0 profiles --export battery-profile.json
python3 victron_cli.py --port /dev/ttyUSB0 profiles --import battery-profile.json --yes
